		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbtpday5exercise1atienza-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday5exercise1atienza-display": {
								"semanticObject": "zbtpday5exercise1atienza",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day5exercise1atienza",
									"url": sap.ui.require.toUrl("zbtp/day5exercise1atienza")
								}
							}
						}
					}
