		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Activity Routing and Navigation",
									"targetURL": "#zbtpday5exercise2atienza-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday5exercise2atienza-display": {
								"semanticObject": "zbtpday5exercise2atienza",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day5exercise2atienza",
									"url": sap.ui.require.toUrl("zbtp/day5exercise2atienza")
								}
							}
						}
					}
